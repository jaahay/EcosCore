...
#ifndef ECOSCORE_EVENT_UTIL_METRICS_CONSOLEMETRICSREPORTER_H
#define ECOSCORE_EVENT_UTIL_METRICS_CONSOLEMETRICSREPORTER_H
...
#endif // ECOSCORE_EVENT_UTIL_METRICS_CONSOLEMETRICSREPORTER_H
