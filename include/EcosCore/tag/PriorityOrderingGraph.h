// EcosCore/tag/PriorityOrderingGraph.h
#ifndef ECOSCORE_TAG_PRIORITY_ORDERING_GRAPH_H
#define ECOSCORE_TAG_PRIORITY_ORDERING_GRAPH_H
...
namespace EcosCore::tag {
    ...
    /**
     * PriorityOrderingGraph manages a DAG of priority tags.
     * Nodes are pointers to priority tag singletons.
     */
...
#endif // ECOSCORE_TAG_PRIORITY_ORDERING_GRAPH_H
