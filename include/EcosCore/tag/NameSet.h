// EcosCore/tag/NameSet.h
#ifndef ECOSCORE_TAG_NAME_SET_H
#define ECOSCORE_TAG_NAME_SET_H
...
namespace EcosCore::tag {
    ...
    struct LocalizedName {
        ...
        constexpr LocalizedName(std::string_view n = "", std::string_view cs = "UTF-8")
            : name(n), charset(cs) {
        }
    };
