...
#ifndef ECOSCORE_INTEGRATIONS_IDENTITYPROVIDERTAGS_H
#define ECOSCORE_INTEGRATIONS_IDENTITYPROVIDERTAGS_H
...
#endif // ECOSCORE_INTEGRATIONS_IDENTITYPROVIDERTAGS_H
