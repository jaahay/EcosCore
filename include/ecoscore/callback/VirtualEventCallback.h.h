...
#ifndef ECOSCORE_ECOSCORE_CALLBACK_VIRTUALEVENTCALLBACK_H_H
#define ECOSCORE_ECOSCORE_CALLBACK_VIRTUALEVENTCALLBACK_H_H
...
#endif // ECOSCORE_ECOSCORE_CALLBACK_VIRTUALEVENTCALLBACK_H_H
